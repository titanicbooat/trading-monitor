...
function mergeOverviewResults(
  ...
  const performance: PerfData | null = hasPerf
    ? {
        ...
        profit_factor:
          totalLoss !== 0 ? Math.round(Math.abs(totalProfit / totalLoss) * 100) / 100 : 0,
        net_profit: Math.round((totalProfit - totalLoss) * 100) / 100,
        total_profit: Math.round(totalProfit * 100) / 100,
        total_loss: Math.round(totalLoss * 100) / 100,
        average_profit: winningTrades > 0 ? Math.round((totalProfit / winningTrades) * 100) / 100 : 0,
        average_loss: losingTrades > 0 ? Math.round((totalLoss / losingTrades) * 100) / 100 : 0,
